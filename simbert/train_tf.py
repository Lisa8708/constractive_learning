...
# 基本信息
maxlen = 64  # 128 机器资源受限
batch_size = 64
steps_per_epoch = 1000
epochs = 10

data_path = "../../data/cnsd-snli/"

corpus_path = data_path + 'train.json'
model_path = data_path + 'model/simbert/'
...
class data_generator(DataGenerator):
    ...
    def __iter__(self, random=False):
        ...
        for is_end, d in self.sample(random):
            ...
            synonyms = [text] + synonyms  # 原始句子与相似句合并为一个list
            np.random.shuffle(synonyms)  # shuffle
...
class Evaluate(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        model.save_weights(model_path + 'latest_model.weights')
        # 保存最优
...
if __name__ == '__main__':
    ...
    model.load_weights(model_path + 'latest_model.weights')
